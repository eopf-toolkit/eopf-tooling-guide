...
The EOPF Zarr example took `r zarr_time_numeric`, while the SAFE example took `r safe_time_numeric`---a difference of `r time_diff` seconds, or `r time_diff_min` minutes.
...
tribble(
  ...
  "EOPF Zarr", zarr_time, "---", "---", obj_size(r60m_tci),
